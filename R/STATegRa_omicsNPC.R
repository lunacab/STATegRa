...
#' TODO NPC: A data.frame??? with the p-values and the q-values (make sure that calling them qvalues is correct) computed through NPC. Column names correspond to combMethods. example: The columns "p_Fisher" and q_Fisher correspond to the p-values and the qvalues generated by the Fisher combining function. 
